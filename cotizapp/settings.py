...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='cotizapp_db'),
...
# AWS S3 Configuration (Only if variables are set)
...
if AWS_ACCESS_KEY_ID:
    AWS_S3_REGION_NAME = 'us-east-1' # Default for AWS Academy
    ...
    # Let boto3 generate the correct signed URLs
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'CotizApp API',
    'DESCRIPTION': 'API REST para sistema de gestión de cotizaciones para PYMEs',
    'VERSION': '1.0.0',
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@cotizapp.com')
