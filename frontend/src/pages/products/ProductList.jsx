    ...
    return (
        <div className="container-custom">
            <div className="card-header-custom" style={{ marginTop: '20px', borderBottom: 'none' }}>
                ...
                <button className={`btn-custom btn-primary ${user?.rol !== 'ADMIN' ? 'd-none' : ''}`} onClick={() => navigate('/productos/nuevo')}>
                            ...
                            <tbody>
                                {filteredProducts.map((product) => (
                                    <tr key={product.id}>
                                        ...
                                        <td>{product.impuesto_total}%</td>
                                        <td style={{ fontWeight: 'bold' }}>
                                            {formatCurrency(productsService.calculateTotal(product.precio, product.impuesto_total))}
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div style={{ display: 'flex', gap: '10px' }}>
                                                {user?.rol === 'ADMIN' ? (
                                                    ...
                                                    <button
                                                        type="button"
                                                        onClick={() => navigate(`/productos/editar/${product.id}?mode=request`)}
